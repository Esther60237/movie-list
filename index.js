(function () {
  ...
  searchForm.addEventListener('submit', function (event) {
    ...
    getPageData(1, pageData)
    if (viewStyle === "th") {
      displayDataList(pageData)
    } else if (viewStyle === "bars") {
      displayDataList2(pageData)
    }
  })

  //listen to changeView
  ...
  // listen to data panel > showMovie、addFavoriteItem
  ...
  //變更頁面排版
  function displayDataList2(pageData) {
    dataPanel.className = "column"
    let htmlContent = ''
